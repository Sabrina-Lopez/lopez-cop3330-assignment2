...
public class App {
    public static void main(String[] args) {
        ...
        System.out.print("\nEnter a search string: "); //ask the user for a search string
        Scanner searchStringInput = new Scanner(System.in); //scan the search string input
        String searchString = searchStringInput.nextLine();

        System.out.println("\nResults: ");

        //print out the list of employee and their info that relate to the user's search
        ...
        for (HashMap<String, String> currentEmployee : employees) {
            ...
            if (employeeName.contains(searchString)) { //if the employee's name contains characters from the search string
